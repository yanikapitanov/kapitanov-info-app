...
@Service
public class PublicTransportInterruptionsServiceImpl implements PublicTransportInterruptionsService {
...
//    id_prefix = "de:09162:"
    ...
    @Override
    public List<TransportResponse> getInterruptionsByLines(final String line) {
